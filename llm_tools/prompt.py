COUNT_NAMES_PROMPT = """
你是一个优秀仔细的历史学家，下面是{file_name}的内容，请你帮我总结出在这些内容中出现了一些什么人名，他们的身份职位分别是什么，请以json格式返回给我，方便我之后对这些人名进行统计分析。
请注意：
...
4. 如果"name_1"中已经出现了一个人的全名，比如说"陈余"，那么"name_2"就不用返回类似"成安君陈余"这样的包括全名的字段，因为这样的字段是重复的。
